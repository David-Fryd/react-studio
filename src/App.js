...
function App() {
  ...
  return (
    <div className="App flex flex-col items-center h-screen text-neutral-800 min-w-[700px]">
      <h1 className="text-5xl md:text-7xl text-center p-10 font-bold bg-neutral-50 w-screen fixed whitespace-nowrap">Bakery Bakery</h1> {/* TODO: personalize your bakery (if you want) */}
      ...
      <div id="shoppingcontainer" className="flex w-full px-5 space-x-5">
        ...
        {bakeryData.map((item, index) => ( // TODO: map bakeryData to BakeryItem components
          ...
          <BakeryItem {...item} cart={cart} addToCart={addToCart} key={item.name} ></BakeryItem>
          </>
        ))}
        </div>
